...
class RaisedPlayer(BasePokerPlayer):
  ...
  def __init__(self):
      self.root = Node("SB", None, 10, 20, ["HA", "S5"], 2, 0)
  ...
  def explore_game_tree(self, round_state, win_rate):
    # print round_state
    # print self.tree.root.children[2].children[2].children[2].children[2].children[1].children[1].children[2].children[2].children[2].children[2].children[1]
    ...
    opponent_num = 0
    print list(map(lambda action: action['action'], actions))
    for action in actions:
      ...
      if action['action'] == 'FOLD':
          ...
          # self.current_node = self.current_node.children[1].children[1] if len(self.current_node.children[1].children) != 0 else self.current_node.children[1]
      elif action['action'] == 'RAISE':
          self.current_node = self.current_node.children[2]
    # print self.current_node.role, self.current_node.SB_bet, self.current_node.BB_bet, self.current_node.depth_count
